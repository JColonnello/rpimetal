...
For protocol details and implementation guide, see [Multiplexing](5.-Multiplexing.md).
...
* [Build System](6.-Build-system.md) — How the Makefile works, adding modules
* [Multiplexing Protocol](5.-Multiplexing.md) — Serial multiplexing for multi-channel I/O
* [Modules](3.-Modules.md) — Available kernel modules and how to create new ones
* [Hardware deployment](4.-Hardware-deployment.md) — Instructions for running on real hardware
* [Bootloaders](2.-Bootloaders.md) — Different bootloader options and their use cases
* [Examples/Tutorials](1.-Examples.md) — Step-by-step tutorials from simple to complex
