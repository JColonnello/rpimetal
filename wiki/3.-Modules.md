...
| Module | Description |
|--------|-------------|
| `sys/mux` | Serial multiplexing. Enables multiple channels over single UART. See [Multiplexing](5.-Multiplexing.md). |
...
- [Build System](6.-Build-system.md) — How modules are compiled and linked
- [Bootloaders](2.-Bootloaders.md) — Different module loading strategies
- [ELF Loader Source](../modules/loader/loader.c) — Implementation details
