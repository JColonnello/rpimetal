...
|---|---------|-------------|------------|--------------|
| 1 | [no-libc-uart](Examples/1.1-no-libc-uart.md) | Minimal "Hello World" | `linked` | Basic UART output, simple-uart driver |
| 2 | [display](Examples/1.2-display.md) | Show an image on\ screen | `linked` | Framebuffer, mailbox, graphics |
| 3 | [0A_misc](Examples/1.3-0A_misc.md) | Interactive echo with timing | `linked` | Full libc, timer, stdin/stdout, interrupts |
...
- [Build System](6.-Build-system.md) — How examples are built
- [Modules](3.-Modules.md) — Available modules and their APIs
- [Bootloaders](2.-Bootloaders.md) — Different bootloader options
